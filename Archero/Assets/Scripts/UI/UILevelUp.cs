...
public class UILevelUp : MonoBehaviour
{
    ...
    public int CurrentCoinGold { get { return _currentCoinGold; } }
    private event GetExperience _getExperience;
    ...
    private void Start()
    {
        ...
        _getExperience += GetCoins;
        _getExperience += LevelUp;
    }
